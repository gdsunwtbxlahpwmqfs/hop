...
# ![Formula transform Icon, role="image-doc-icon"](../../assets/images/transforms/icons/formula.svg) Formula
...
> **💡 提示:** Check the Apache POI docs page for a [list of support formulas](https://poi.apache.org/components/spreadsheet/eval-devguide#What`functions`are+supported).
