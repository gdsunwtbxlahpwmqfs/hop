# ![Salesforce Update transform Icon, role="image-doc-icon"](../../assets/images/transforms/icons/SFUD.svg) Salesforce Update
...
- Transform name：指定画布上 Salesforce Update transform 的唯一名称。
您可以自定义名称或保留默认值。
