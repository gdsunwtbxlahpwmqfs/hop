...
Workflow 可以在本地或远程执行。
查看 [Workflow 运行配置](../08-工作流/workflow-run-configurations.md)了解更多详情。
...
| Execution information location | 与此 Workflow 运行配置一起使用的 [metadata-types/execution-information-location.adoc](execution-information-location.md)。 |
