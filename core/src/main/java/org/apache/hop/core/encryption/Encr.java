...
public class Encr {
  ...
  private static void printOptions() {
    ...
    System.err.println("    -hop: generate an obfuscated password to include in Qi Hop XML files");
    System.err.println(
        "    -server : generate an obfuscated password to include in the qi-hop-server password file 'pwd/hop.pwd'");
    System.err.println(
    ...
    System.err.println(
        "Qi Hop will then be able to make the distinction between regular plain text passwords and obfuscated ones.");
    System.err.println();
  }
}
